...
const TAGS_ROW2 = ["Increased Engagement", "Expandable", "Secure", "User-Friendly"];

const FEATURE_CARDS = [
  {
    id: "requests",
    size: "large",          // spans full left column top
    image: "https://images.unsplash.com/photo-1614854262318-831574f15f1f?w=700&auto=format&fit=crop&q=80",
    imageOverlay: true,
    glowColor: "#3B6EF8",
    label: null,
    badge: null,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1560472355-536de3962603?w=400&auto=format&fit=crop&q=80",
    glowColor: "#2563EB",
    badge: null,
...
function GlowBadge({ label, color = "#3B6EF8" }) {
  return (
    <Box sx={{
      ...
      px: 1.2, py: 0.35, borderRadius: "6px", fontSize: 10, fontWeight: 800,
      letterSpacing: 0.8,
      background: color === "#8B5CF6" ? "rgba(139,92,246,0.2)" : "rgba(59,110,248,0.2)",
  ...
  return (
    ...
    >
      <Box sx={{
        ...
        background: "linear-gradient(148deg, rgba(10,18,52,0.92) 0%, rgba(6,10,30,0.96) 100%)",
        backdropFilter: "blur(18px)",
        overflow: "hidden",
        position: "relative",
        boxShadow: "0 8px 40px rgba(0,0,20,0.5), inset 0 1px 0 rgba(255,255,255,0.05)",
...
export default function BenefitsSection() {
  ...
  return (
    <Box
      ref={sectionRef}
      sx={{ background: "#020718", position: "relative", overflow: "hidden", py: { xs: 8, md: 14 } }}
    >
      {/* Ambient glows */}
      <Box sx={{ position: "absolute", top: "10%", left: "30%", width: 600, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(59,110,248,0.07) 0%, transparent 70%)", filter: "blur(90px)", pointerEvents: "none" }} />
      <Box sx={{ position: "absolute", bottom: "10%", right: "5%", width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(139,92,246,0.06) 0%, transparent 70%)", filter: "blur(70px)", pointerEvents: "none" }} />
      ...
      <Container maxWidth="xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }}>
          <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 3 }}>
            ...
            <Typography sx={{ fontSize: 12, color: "#7da4ff", fontWeight: 700, letterSpacing: 1.5 }}>LANDIN BENEFITS</Typography>
          </Stack>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.55, delay: 0.18 }}>
          <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mb: 1 }}>
            {TAGS_ROW1.map((tag) => (
              <Box key={tag} sx={{
                px: 1.8, py: 0.55, borderRadius: "7px", fontSize: 12, fontWeight: 500,
          ...
          <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mb: 6 }}>
            ...
            <Button size="small" variant="contained" sx={{
              px: 2, py: 0.55, fontSize: 12, fontWeight: 700, textTransform: "none",
              background: "linear-gradient(135deg, #3B6EF8, #5b8fff)",
              borderRadius: "7px", border: "1px solid rgba(255,255,255,0.14)",
              boxShadow: "0 3px 14px rgba(59,110,248,0.35)",
        ...
        <Box sx={{
          ...
          <GlassCard glowColor="#3B6EF8" delay={0.1} inView={inView} sx={{ gridRow: { lg: "1 / 3" } }}>
            {/* Hero image */}
            <Box sx={{ position: "relative", height: { xs: 200, sm: 220, lg: 260 }, overflow: "hidden" }}>
              <Box
                component="img"
                src="https://images.unsplash.com/photo-1614854262318-831574f15f1f?w=700&auto=format&fit=crop&q=80"
                alt="Next button"
                sx={{ width: "100%", height: "100%", objectFit: "cover", filter: "brightness(0.75) saturate(1.3)" }}
              />
              {/* Blue neon glow overlay */}
              <Box sx={{
                position: "absolute", inset: 0,
                background: "linear-gradient(180deg, rgba(59,110,248,0.15) 0%, rgba(2,7,24,0.55) 100%)",
              }} />
            ...
            <Box sx={{ p: 3 }}>
              ...
              <Stack direction="row" spacing={1.5}>
                ...
                <Button size="small" sx={{
                  px: 2, py: 1, fontSize: 13, fontWeight: 600, textTransform: "none",
          ...
          <GlassCard glowColor="#3B6EF8" delay={0.18} inView={inView} sx={{ gridColumn: { lg: "2 / 4" } }}>
            <Box sx={{ p: 3, display: "flex", flexDirection: { xs: "column", sm: "row" }, gap: 3, alignItems: "flex-start" }}>
              {/* App icons */}
              <Box sx={{ flexShrink: 0 }}>
                <Box sx={{
                  ...
                  {[
                    ...
                    <Box key={letter} sx={{ textAlign: "center" }}>
                      ...
                      <Typography sx={{ fontSize: 9, color: "rgba(255,255,255,0.4)", letterSpacing: 0.3 }}>{label}</Typography>
                    </Box>
                  ))}
                </Box>
              </Box>
              <Box sx={{ flex: 1 }}>
                ...
                <Typography sx={{ fontSize: 13, color: "rgba(255,255,255,0.5)", lineHeight: 1.75 }}>
          ...
          <GlassCard glowColor="#3B6EF8" delay={0.26} inView={inView}>
            <Box sx={{ position: "relative", height: 120, overflow: "hidden" }}>
              <Box component="img"
                ...
                alt="Quick"
                sx={{ width: "100%", height: "100%", objectFit: "cover", filter: "brightness(0.5) saturate(0.8)" }}
              />
              ...
              <Box sx={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, transparent 30%, rgba(10,18,52,0.9) 100%)" }} />
            </Box>
            <Box sx={{ p: 2.5 }}>
          ...
          <GlassCard glowColor="#2563EB" delay={0.32} inView={inView}>
            <Box sx={{ position: "relative", height: 120, overflow: "hidden" }}>
              <Box component="img"
                ...
                alt="Publish"
                sx={{ width: "100%", height: "100%", objectFit: "cover", filter: "brightness(0.45) saturate(0.7)" }}
              />
              <Box sx={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, transparent 30%, rgba(6,10,30,0.9) 100%)" }} />
              {/* Fake code/button UI overlay */}
              <Box sx={{
                position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-60%)",
                px: 2, py: 0.8, borderRadius: "8px",
                background: "rgba(59,110,248,0.85)", backdropFilter: "blur(8px)",
                border: "1px solid rgba(255,255,255,0.2)",
                boxShadow: "0 4px 20px rgba(59,110,248,0.5)",
              }}>
                <Typography sx={{ fontSize: 11, fontWeight: 700, color: "#fff", letterSpacing: 0.5 }}>Publish</Typography>
              </Box>
            </Box>
            <Box sx={{ p: 2.5 }}>
            ...
            <Box sx={{ p: 3, height: "100%", display: "flex", flexDirection: "column" }}>
              ...
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <Typography sx={{ fontSize: 34, lineHeight: 1, filter: "drop-shadow(0 0 16px rgba(139,92,246,0.8))" }}>
                    💎
                  </Typography>
                  {/* Orbiting dot */}
                  <motion.div
                  ...
                  >
                    <Box sx={{ width: 8, height: 8, borderRadius: "50%", background: "#8B5CF6", boxShadow: "0 0 8px #8B5CF6", mt: "-4px" }} />
                  </motion.div>
                </Box>
              </Box>
              ...
              <Typography sx={{ fontSize: 12.5, color: "rgba(255,255,255,0.5)", lineHeight: 1.75 }}>
