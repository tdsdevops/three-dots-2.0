...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "From custom logo designs to comprehensive brand guidelines, web design, and marketing materials, we cover all aspects of your visual presence.",
    price: "$4500",
    duration: "3–4",
  ...
  },
  {
    ...
    desc: "Whether you're building a simple website or a complex web application, our team provides scalable solutions tailored to your needs, ensuring your project is robust.",
    price: "$7500",
    duration: "4–6",
    ...
    >
      <Box
        sx={{
          ...
          background: "linear-gradient(148deg, rgba(10,18,58,0.94) 0%, rgba(6,11,34,0.97) 100%)",
          backdropFilter: "blur(20px)",
          p: { xs: 3, md: 3.5 },
          position: "relative",
          overflow: "hidden",
          boxShadow: "0 8px 40px rgba(0,0,24,0.55), inset 0 1px 0 rgba(255,255,255,0.05)",
          transition: "border-color 0.3s ease, box-shadow 0.3s ease",
          "&:hover": {
            borderColor: isPurple ? "rgba(139,92,246,0.4)" : "rgba(59,110,248,0.38)",
            boxShadow: isPurple
      ...
      >
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            background: isPurple ? "rgba(139,92,246,0.13)" : "rgba(59,110,248,0.12)",
            border: `1px solid ${isPurple ? "rgba(139,92,246,0.28)" : "rgba(59,110,248,0.26)"}`,
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 16, color: isPurple ? "#b794ff" : "#7da4ff",
          }}>
            {service.icon}
          </Box>
          <Chip
            ...
            size="small"
            sx={{
              background: isPurple ? "rgba(139,92,246,0.15)" : "rgba(59,110,248,0.13)",
        ...
        <Typography sx={{
          ...
          color: "#fff", mb: 1.2, position: "relative", zIndex: 1,
        }}>
          {service.title}
        </Typography>
        ...
        <Typography sx={{
          ...
          lineHeight: 1.75, mb: 2.5, position: "relative", zIndex: 1,
        }}>
          {service.desc}
        </Typography>

        {/* Price + Duration pills */}
        <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5, position: "relative", zIndex: 1 }}>
          <Box sx={{
            ...
            <Typography sx={{ fontFamily: "Syne", fontWeight: 800, fontSize: 15, color: "#fff" }}>
              {service.price}
            </Typography>
            <Typography sx={{ fontSize: 11, color: "rgba(255,255,255,0.4)" }}>/ Project</Typography>
          </Box>
          <Box sx={{
            px: 2, py: 0.75, borderRadius: "8px",
            background: "rgba(255,255,255,0.05)",
            ...
            <Typography sx={{ fontSize: 12, color: "rgba(255,255,255,0.55)", fontWeight: 500 }}>
        ...
        {/* Feature list */}
        <Stack spacing={1} sx={{ mb: service.cta ? 3 : 0, position: "relative", zIndex: 1 }}>
          {service.features.map((f) => (
            <Stack key={f} direction="row" spacing={1.2} alignItems="center">
              <CheckCircleIcon sx={{ color: service.badgeColor, fontSize: 15, flexShrink: 0 }} />
              <Typography sx={{ fontSize: 13, color: "rgba(255,255,255,0.65)", fontWeight: 500 }}>
                {f}
              </Typography>
            </Stack>
          ))}
        ...
        {service.cta && (
          ...
          >
            <Button
              variant="contained"
              sx={{
                px: 3, py: 1.2, fontSize: 13.5, fontWeight: 700,
                background: "linear-gradient(135deg, #3B6EF8, #5b8fff)",
                borderRadius: "10px",
                border: "1px solid rgba(255,255,255,0.14)",
                textTransform: "none",
                boxShadow: "0 4px 18px rgba(59,110,248,0.38), inset 0 1px 0 rgba(255,255,255,0.18)",
                "&:hover": {
  ...
  return (
    ...
    >
      ...
      <Box sx={{
        ...
        width: { xs: 220, md: 500 }, height: { xs: 220, md: 500 },
        borderRadius: "50%",
          ...
          <Box sx={{
            ...
            >
              <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 2.5 }}>
                <Box sx={{
                  ...
                  background: "#3B6EF8", boxShadow: "0 0 8px #3B6EF8",
                }} />
            ...
            >
              <Typography sx={{
                ...
                fontSize: { xs: "2rem", sm: "2.5rem", md: "2.9rem", xl: "3.3rem" },
                color: "#fff", lineHeight: 1.1, mb: 0.4,
              }}>
                Get High–Quality
              </Typography>
              <Typography sx={{
                fontFamily: "Syne", fontWeight: 800,
                fontSize: { xs: "2rem", sm: "2.5rem", md: "2.9rem", xl: "3.3rem" },
                color: "#fff", lineHeight: 1.1, mb: 2.5,
              }}>
                ...
                <Box sx={{ position: "relative", borderRadius: "16px", overflow: "hidden" }}>
                  <Box
                    ...
                    sx={{
                      ...
                      objectFit: "cover",
                      boxShadow: "0 24px 70px rgba(0,0,24,0.55), 0 0 0 1px rgba(255,255,255,0.06)",
                    }}
                  />
                  {/* Image overlay */}
                  <Box sx={{
                    position: "absolute", inset: 0,
                    background: "linear-gradient(180deg, transparent 40%, rgba(2,7,24,0.6) 100%)",
                  }} />
                  {/* Floating badge */}
                  <motion.div
                  ...
                  >
                    <Typography sx={{ fontSize: 10, color: "#7da4ff", fontWeight: 700, letterSpacing: 1, mb: 0.3 }}>
                      CLIENT SATISFACTION
                    </Typography>
                    <Typography sx={{ fontFamily: "Syne", fontWeight: 800, fontSize: 20, color: "#fff" }}>
                      98%
                    </Typography>
                  </motion.div>
                </Box>
