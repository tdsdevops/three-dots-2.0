...
export default function SEO({
  ...
  const localBusinessSchema = {
    ...
    "image": ogImage,
    "url": "https://three-dots.in",
    "telephone": "+919444300000", // Representative local phone number
    "priceRange": "$$",
    "address": {
      "@type": "PostalAddress",
  ...
  const getBreadcrumbs = () => {
    ...
    if (pageKey === "about") {
      items.push({
        ...
        "position": 2,
        "name": "About Us",
        "item": "https://three-dots.in/about"
      });
      ...
      items.push({
        ...
        "position": 2,
        "name": "Portfolio",
        "item": "https://three-dots.in/portfolio"
      });
      ...
      items.push({
        ...
        "position": 2,
        "name": "Contact Us",
        "item": "https://three-dots.in/contact"
      });
      ...
      items.push({
        ...
        "position": 3,
        "name": blogPost.title,
        "item": `https://three-dots.in/blog/${blogPost.id}`
      });
    }
  ...
  return (
    <Helmet>
      ...
      {/* Local Business schema on all pages or selectively */}
      <script type="application/ld+json">
